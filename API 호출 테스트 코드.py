...
df = pd.read_excel('상장사 감액배당 실태조사_20250428_v1 (1).xlsx', sheet_name='상장사 정보',dtype=str)
...
E006_24to25df = collect_report_list(df)
E006_24to25df.to_excel('2024-2025년 상장사 주총공고(최종).xlsx', index= False)